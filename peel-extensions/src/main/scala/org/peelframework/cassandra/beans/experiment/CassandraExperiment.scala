package org.peelframework.cassandra.beans.experiment
...
import org.peelframework.cassandra.beans.system.Cassandra
import spray.json._
...
object CassandraExperiment {
  ...
  class SingleJobRun(val id: Int, val exp: CassandraExperiment, val force: Boolean) extends Experiment.SingleJobRun[Cassandra, State] {
    ...
    import org.peelframework.cassandra.beans.experiment.CassandraExperiment.StateProtocol._
